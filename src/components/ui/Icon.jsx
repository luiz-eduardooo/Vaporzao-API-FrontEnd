// Componente de ícone simples. Cada ícone é desenhado em viewBox 24x24 e usa
// "currentColor", então herda a cor do texto do elemento pai.
//
// Uso:  <Icon nome="busca" className="w-4 h-4" />
